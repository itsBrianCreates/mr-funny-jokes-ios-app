...
const JOKES_TO_ADD = [
  {
    "character": "mr_funny",
    "text": "What do you get if you cross a snowman and a dog? Frost-bite!",
    "type": "dad_joke",
    "tags": ["christmas", "holidays", "animals"],
    "sfw": true,
    "source": "classic",
    "likes": 0,
    "dislikes": 0,
  ...
  {
    "character": "mr_funny",
    "text": "Why did the tree go to the barber? It needed a trim!",
    "type": "dad_joke",
    "tags": ["christmas", "holidays", "wordplay"],
    "sfw": true,
    "source": "classic",
    "likes": 0,
    "dislikes": 0,
  ...
  {
    "character": "mr_funny",
    "text": "What's an elf's favorite musical genre? Wrap music!",
    "type": "dad_joke",
  ...
  {
    "character": "mr_funny",
    "text": "Why are Christmas trees bad at knitting? They always drop their needles!",
    "type": "dad_joke",
    "tags": ["christmas", "holidays", "wordplay"],
    "sfw": true,
    "source": "classic",
  ...
  {
    "character": "mr_funny",
    "text": "What do you give a snowman with a fever? A chill pill!",
    "type": "dad_joke",
    "tags": ["christmas", "holidays", "health"],
    "sfw": true,
    "source": "classic",
    "likes": 0,
    "dislikes": 0,
  ...
  {
    "character": "mr_funny",
    "text": "Why is December such a cool month? Because it has Brrrr in the name!",
    "type": "dad_joke",
    "tags": ["christmas", "holidays", "weather"],
    "sfw": true,
    "source": "classic",
    "likes": 0,
    "dislikes": 0,
  ...
  {
    "character": "mr_funny",
    "text": "Why did the Elf go to school? To improve his elf-abet!",
    "type": "dad_joke",
    "tags": ["christmas", "holidays", "school"],
    "sfw": true,
    "source": "classic",
    "likes": 0,
    "dislikes": 0,
  ...
  {
    "character": "mr_funny",
    "text": "What did Frosty's girlfriend give him when she was mad at him? The cold shoulder!",
    "type": "dad_joke",
    "tags": ["christmas", "holidays", "wordplay"],
    "sfw": true,
    "source": "classic",
  ...
  {
    "character": "mr_funny",
    "text": "What do gingerbread men use when they break their legs? Candy canes!",
    "type": "dad_joke",
    "tags": ["christmas", "holidays", "food"],
    "sfw": true,
    "source": "classic",
    "likes": 0,
    "dislikes": 0,
  ...
  {
    "character": "mr_funny",
    "text": "What do donkeys send out near Christmas? Mule-tide greetings!",
    "type": "dad_joke",
    "tags": ["christmas", "holidays", "animals"],
    "sfw": true,
    "source": "classic",
  ...
  {
    "character": "mr_funny",
    "text": "How did the reindeer learn to play piano? He was elf-taught!",
    "type": "dad_joke",
    "tags": ["christmas", "holidays", "music", "animals"],
    "sfw": true,
    "source": "classic",
    "likes": 0,
    "dislikes": 0,
