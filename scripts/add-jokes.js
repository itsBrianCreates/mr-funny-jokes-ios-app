...
const JOKES_TO_ADD = [
  {
    "character": "mr_funny",
    "text": "Why are Christmas trees so bad at knitting? They always drop their needles.",
    "type": "dad_joke",
  ...
  {
    "character": "mr_funny",
    "text": "What's a snowman's favorite drink? Iced tea.",
    "type": "dad_joke",
  ...
  {
    "character": "mr_funny",
    "text": "What's every parent's favorite Christmas carol? Silent Night.",
    "type": "dad_joke",
    "tags": ["christmas", "holidays", "family", "music"],
    "sfw": true,
    "source": "classic",
    "likes": 0,
    "dislikes": 0,
