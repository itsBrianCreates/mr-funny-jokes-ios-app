...
const JOKES_TO_ADD = [
  ...
  {
    "character": "mr_bad",
    "text": "What does Beethoven do in a graveyard? De-compose!",
    "type": "dad_joke",
    "tags": ["music", "wordplay"],
    "sfw": true,
    "source": "classic",
  ...
  {
    "character": "mr_bad",
    "text": "Why do nurses use red crayons? To draw blood!",
    "type": "dad_joke",
    "tags": ["health", "work"],
    "sfw": true,
    "source": "classic",
  ...
  {
    "character": "mr_potty",
    "text": "Why do ducks have feathers? To cover their butt quack!",
    "type": "dad_joke",
  ...
  {
    "character": "mr_funny",
    "text": "Why don't elephants use computers? Because they're afraid of the mouse!",
    "type": "dad_joke",
  ...
  {
    "character": "mr_funny",
    "text": "I was going to make up a joke about carpentry… but none of them wood work!",
    "type": "dad_joke",
    "tags": ["work", "wordplay"],
    "sfw": true,
    "source": "classic",
  ...
  {
    "character": "mr_funny",
    "text": "Why did the pharmacist walk on their tiptoes? They didn't want to wake the sleeping pills!",
    "type": "dad_joke",
    "tags": ["health", "wordplay"],
    "sfw": true,
    "source": "classic",
    "likes": 0,
    "dislikes": 0,
  ...
  {
    "character": "mr_funny",
    "text": "Why did the lemon stop in the middle of the road? Because it ran out of juice!",
    "type": "dad_joke",
    "tags": ["food", "wordplay"],
    "sfw": true,
    "source": "classic",
  ...
  {
    "character": "mr_sad",
    "text": "I was raised as an only child, which I think was hard for my brother.",
    "type": "dad_joke",
    "tags": ["family"],
    "sfw": true,
    "source": "classic",
